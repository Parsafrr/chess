/**
 * Initialize board UI interactions. Call with the `game` instance after it is created.
 * @param {Object} game - game object exported from script.js
 */
export function initDesignBoard(game) {
